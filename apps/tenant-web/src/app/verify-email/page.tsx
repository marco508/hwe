...
function VerifyContent() {
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Votre compte est actif : contactez, candidatez, suivez votre bail.
        </p>
        <Link href="/">
          <Button className="w-full">Chercher un logement</Button>
        </Link>
      </div>
    );
  }
  return (
    <div className="text-center">
      ...
      <Link href="/">
        <Button variant="secondary" className="w-full">Retour à l'accueil</Button>
      </Link>
    </div>
  );
}
